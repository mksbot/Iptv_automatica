...
const BotName = 'RPG-ONE PIECE⚔️ bot'; 
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:RPG-ONE PIECE⚔️\n' // Nama kamu
            + 'ORG:MIKA;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=559885894652:+55 9885894652\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '-','=','_'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[🌀] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD RPG-ONE PIECE⚔️ BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[🌀] RPG-ONE PIECE⚔️? Este é um recurso especial para o RPG-ONE PIECE⚔️ ❌',
					ownerB: '[🌀] RPG-ONE PIECE⚔️? Este é um recurso especial para o RPG-ONE PIECE⚔️ ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de RPG-ONE PIECE⚔️. Registre-se para fazer amizade com o bot RPG-ONE PIECE⚔️ por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar RPG-ONE PIECE⚔️|17\n\n──「 RPG-ONE PIECE⚔️ BOT 」──`,
			...
			const ownerNumber = ["559885894652@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"559885894652@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["559885894652@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["559885894652@s.whatsapp.net"]//ubah nomor lo
			const premium = ["559885894652@s.whatsapp.net"] 
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("fdp")){
	    ...
	    if (messagesC.includes("RPG-ONE PIECE⚔️")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/RPG-ONE PIECE⚔️.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS RPG-ONE PIECE⚔️ BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @RPG-ONE PIECE⚔️ domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o RPG-ONE PIECE⚔️ ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT RPG-ONE PIECE⚔️ ✨* 」\n*│+ wa.me/559885894652*╰──────*「 *RPG-ONE PIECE⚔️* 」*────*\n\n*_SE QUER SER ADMIN DO BOT RPG-ONE PIECE⚔️_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do RPG-ONE PIECE⚔️:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
           ...
           case 'shitlist':
               ...
               break
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* RPG-ONE PIECE⚔️\n* *WPP:* wa.me/+559885894652\n*\n\n\nEspero que tenham gostado do bot 💥🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
