...
const BotName = 'YANERU_BOT⚔️ bot'; 
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:YANERU_BOT⚔️\n' // Nama kamu
            + 'ORG:YANERU_BOT;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=17013438486:+1 7013438486\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '-','=','_'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[🌀] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD YANERU_BOT⚔️ BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[🌀] YANERU_BOT⚔️? Este é um recurso especial para o YANERU_BOT⚔️ ❌',
					ownerB: '[🌀] YANERU_BOT⚔️? Este é um recurso especial para o YANERU_BOT⚔️ ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de YANERU_BOT⚔️. Registre-se para fazer amizade com o bot YANERU_BOT⚔️ por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar YANERU_BOT⚔️|17\n\n──「 YANERU_BOT⚔️ BOT 」──`,
			...
			const ownerNumber = ["17013438486@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"17013438486@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["17013438486@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["17013438486@s.whatsapp.net"]//ubah nomor lo
			const premium = ["17013438486@s.whatsapp.net"] 
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
	...
	if (messagesC.includes("fdp")){
	    ...
	    if (messagesC.includes("YANERU_BOT⚔️")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/YANERU_BOT⚔️.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS YANERU_BOT⚔️ BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @YANERU_BOT⚔️ domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o YANERU_BOT⚔️ ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT YANERU_BOT⚔️ ✨* 」\n*│+ wa.me/17013438486*╰──────*「 *YANERU_BOT⚔️* 」*────*\n\n*_SE QUER SER ADMIN DO BOT YANERU_BOT⚔️_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do YANERU_BOT⚔️:*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
           ...
           case 'shitlist':
               ...
               break
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* YANERU_BOT⚔️\n* *WPP:* wa.me/+17013438486\n*\n\n\nEspero que tenham gostado do bot 💥🚩️'})
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
